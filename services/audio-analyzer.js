...
export function buildScoringPrompt(audioFeatures, listeningAnswers = "", albumMetadata = {}, platformRatings = null, heatData = null, lyrics = "", researchData = null, ratingScope = "song", oneLinerLang = "zh", finalWord = null) {
  ...
  prompts.push("- 禁止 AI 写作腔：不要“总体来说/整体而言/值得一提的是/可圈可点/恰到好处/无疑/堪称/展现了/呈现出/充满了/富有/兼具/一方面…另一方面”这类套路；不要每句都套“BPM 暗示…”“LUFS 说明…”的固定句式；句子长短错落，像真人乐评自然书写");
  prompts.push("- 客观参数可以写，但必须服务于观点且有信息量：响度/动态/频谱/立体声/时长等要转化成听感判断（如“响度压得很满、几乎没有呼吸感，是典型 club 母带取向”）；禁止无信息量陈述，例如单独报“BPM 128”“峰值顶破 0 dB”（等于说有声）这类读完没有收获的句子；数据要么解释它对听感的意义，要么不写");
